        ...
        foreach ($contratos as $contratoData) {
            ...
            if (rand(1, 100) > 40) {
                ...
                for ($i = 1; $i <= $numSuplementos; $i++) {
                    $fechaFirma = $this->getSuplementoFecha($contrato->fecha_firma, $i);
                    Suplemento::create([
                        ...
                        'fecha_fin_vigencia' => $contrato->fecha_fin_vigencia ? $contrato->fecha_fin_vigencia->copy()->addMonths($i)->format('Y-m-d') : null,
