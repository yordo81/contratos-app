...
class ContratoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $contratos = [
            ...
            [
                ...
                'fecha_inicio_vigencia' => '2025-03-01',
            ...
            [
                ...
                'fecha_inicio_vigencia' => '2025-08-01',
            ...
            [
                ...
                'observaciones' => 'Rechazado por incumplimiento de requisitos de licitacion. No presento póliza de cumplimiento.',
                'archivo_contrato' => null,
            ],
            [
            ...
            [
                ...
                'fecha_inicio_vigencia' => '2025-05-01',
                'fecha_fin_vigencia' => '2025-11-30',
                'observaciones' => 'En proceso de validacion de precios con基准 de referencia. Contrato sujeto a disponibilidad presupuestal.',
                'archivo_contrato' => null,
            ],
            [
                ...
                'fecha_fin_vigencia' => '2025-12-31',
                'observaciones' => 'Servicio en planta. Incluye refacciones基础icas.',
                'archivo_contrato' => null,
            ],
            [
            ...
            if (rand(1, 100) > 40) {
                ...
                for ($i = 1; $i <= $numSuplementos; $i++) {
                    Suplemento::create([
                        ...
                        'descripcion' => $this->getSuplementoDescripcion($i, $contrato->tipo_contrato),
    ...
    private function getSuplementoDescripcion(int $numero, string $tipoContrato): string
    {
        ...
        $opciones = $tipoContrato === 'Prestacion de servicios' ? $descripcionesServicios : $descripcionesCompra;
